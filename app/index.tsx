...
export default function HomeScreen() {
  ...
  return <SafeAreaView style={styles.safeArea}><ScrollView contentContainerStyle={styles.content}>
    <View style={styles.hero}>
      <Text style={styles.kicker}>READY. SHIFT. SWEAT.</Text>
      <Text
        numberOfLines={1}
      ...
      <Text style={styles.subtitle}>Simple intervals. Big effort. No account required.</Text>
    </View>
...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: '#F6F4EF' }, content: { padding: 22, paddingBottom: 40, gap: 14 }, hero: { paddingVertical: 20, width: '100%', alignSelf: 'stretch' }, kicker: { color: '#148A50', fontSize: 13, fontWeight: '900', letterSpacing: 2 }, title: { color: '#171A18', fontSize: 42, lineHeight: 48, fontWeight: '900', letterSpacing: -1.8, marginTop: 6, width: '100%' }, subtitle: { color: '#666C68', fontSize: 17, lineHeight: 24, marginTop: 8, maxWidth: 310 }, sectionTitle: { color: '#777B78', fontSize: 12, fontWeight: '900', letterSpacing: 1.5, marginTop: 4 },
